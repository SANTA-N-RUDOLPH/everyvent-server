...
public class CalendarController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "INVALID_INPUT: 요청 형식 오류"),
            @ApiResponse(responseCode = "403", description = "FORBIDDEN: 공식 캘린더는 관리자만 생성 가능"),
            @ApiResponse(responseCode = "404", description = "NOT_FOUND: 사용자를 찾을 수 없음")
    ...
    public ResponseEntity<Void> distributeOfficialCalendar(
        ...
        Long userId = AuthenticationUtil.getCurrentUserId();
        calendarService.distributeOfficialCalendar(userId, calendarId);
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "404", description = "NOT_FOUND: 캘린더를 찾을 수 없음")
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "INVALID_INPUT: 요청 형식 오류"),
            @ApiResponse(responseCode = "403", description = "FORBIDDEN: 캘린더 수정 권한 없음"),
            @ApiResponse(responseCode = "404", description = "NOT_FOUND: 사용자/캘린더를 찾을 수 없음")
    })
    ...
    public ResponseEntity<CalendarResponse> updateCalendar(
        ...
        Long userId = AuthenticationUtil.getCurrentUserId();
        CalendarResponse response = calendarService.updateCalendar(userId, calendarId, request);
        return ResponseEntity.ok(response);
    }
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "403", description = "FORBIDDEN: 캘린더 삭제 권한 없음"),
            @ApiResponse(responseCode = "404", description = "NOT_FOUND: 사용자/캘린더를 찾을 수 없음")
    })
